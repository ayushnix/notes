...
At this point, realistically, our query can often be found in the DNS cache of
...
A `CNAME` record can't be used to point the apex domain to another domain. This
